# project is done within 8 days
# gui based project for school cs project - converter program
# made by Jatin
...
#root.iconbitmap(r'C:\Users\Jatin\Desktop\bases (1).ico')
root.iconbitmap('C:\\Users\\Jatin\\OneDrive\\Desktop\\bases (1).ico') 
...
def startprogram():
    ...
    def d():
        ...
        top1.title("binary to other bases ~ jatin")
    ...
    def o():
        ...
        top2.title("octal to other bases ~ jatin")
    ...
    def hd():
        ...
        top3.title("hexa-decimal to other bases ~ jatin")
...
img1 = PhotoImage(file="pro tkin image.png")
...
my_label = Button(image=my_img,background="white",width=200,height=60,relief=SOLID,border=3, command=startisclicked)
my_label.pack()
